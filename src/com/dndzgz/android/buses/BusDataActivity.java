...
public class BusDataActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getIntent().hasExtra("object")) {
			autobusInfo = getIntent().getStringExtra("object");
		}
		try {
			autobusJson = new JSONObject(autobusInfo);
			autobusJson.put("type", "bus");
			dndzgzApp.setLastObject(autobusJson);
		...
		Intent FavIntent = new Intent(BusDataActivity.this, FavoritesActivity.class);
